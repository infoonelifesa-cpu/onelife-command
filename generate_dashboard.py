...
def generate():
    ...
    paperclip_dashboard_url = f"{paperclip_url.rstrip('/')}/ONE/dashboard" if paperclip_url else None
    paperclip_link = (
        f'<a class="paperclip-link" href="{paperclip_dashboard_url}" target="_blank" rel="noopener noreferrer">📎 Paperclip</a>'
        if paperclip_dashboard_url else
